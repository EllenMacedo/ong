...
-- Tabela de voluntários (especialização de usuário)
...
-- Tabela de doadores (especialização de usuário)
CREATE TABLE doador (
...
-- Tabela de beneficiários (especialização de usuário)
